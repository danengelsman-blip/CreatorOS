...
import { ArrowRight, Check, Star, Globe, TwitterLogo as Twitter, YoutubeLogo as Youtube, InstagramLogo as Instagram, Lightning as Zap, Shield, List as Menu, X, CaretRight as ChevronRight, TrendUp as TrendingUp, Target, Palette } from '@phosphor-icons/react';
        ...
        <div className="max-w-7xl mx-auto w-full flex items-center justify-between">
          ...
          <div className="hidden md:flex items-center gap-8">
            ...
            <a 
              ...
              className="text-[15px] font-bold text-[var(--accent)] cursor-pointer"
            >
              Sign In
            </a>
            <button 
              onClick={handleSignIn}
              className="ios-button ios-button-tinted h-9 px-4 text-[14px]"
            >
              Get Started
            </button>
          </div>
          ...
          <div 
            className="md:hidden p-2 text-[var(--label-secondary)] cursor-pointer"
            role="button"
      ...
      <AnimatePresence>
        {isMobileMenuOpen && (
          ...
          >
            ...
            <button 
              onClick={handleSignIn}
              className="ios-button ios-button-tinted w-full text-[17px]"
            >
              Sign In
            </button>
          </motion.div>
      ...
      <section className="pt-44 pb-20 px-6">
        <div className="max-w-4xl mx-auto text-center space-y-8">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4 pt-4">
            <button 
              onClick={handleSignIn}
              className="ios-button ios-button-filled w-full sm:w-auto h-14 px-10 text-[17px]"
            >
              Start Your Journey
            ...
            <button 
              onClick={handleSignIn}
              className="ios-button ios-button-gray w-full sm:w-auto h-14 px-10 text-[17px]"
            >
              Sign In
            </button>
          </div>
      ...
      <section id="pricing" className="py-32 px-6">
        <div className="max-w-3xl mx-auto">
          ...
          <div className="mt-8 text-center">
             <button onClick={handleSignIn} className="ios-button ios-button-tinted w-full h-14 text-[17px]">
