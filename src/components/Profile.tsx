...
export default function Profile({ user, brand }: { user: any, brand: any }) {
  ...
  return (
    <div className="space-y-10">
      ...
      <div className="premium-card p-10 bg-premium-ink text-white relative overflow-hidden shadow-2xl shadow-black/20">
        <div className="relative z-10 flex flex-col md:flex-row items-center gap-10">
          ...
          <div className="flex-1 text-center md:text-left space-y-4">
            <div>
              <div className="flex items-center justify-center md:justify-start gap-3 mb-1">
                <h2 className="text-4xl font-extrabold tracking-tight">{user?.displayName || 'Creator'}</h2>
                {user?.avatarType === 'ai_generated' && (
          ...
          <div className="flex flex-col gap-3">
            ...
            <div className="flex gap-3">
              ...
              <button className="flex-1 px-8 py-4 bg-white text-premium-ink rounded-2xl font-bold text-sm hover:scale-[1.02] active:scale-[0.98] transition-all shadow-xl">
                Edit Profile
              </button>
            </div>
          </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
        <div className="premium-card p-10 bg-white">
          ...
          <div className="space-y-6">
            <div className="p-6 bg-gray-50 rounded-2xl border border-black/[0.03]">
        ...
        <div className="premium-card p-10 bg-white">
          ...
          <div className="space-y-4">
            ...
            <div className="flex items-center justify-between py-3 border-bottom border-premium-border">
              ...
              <span className="font-bold text-accent-violet">Creator Pro</span>
            </div>
            <div className="flex items-center justify-between py-3 border-bottom border-premium-border">
