    ...
    <div className="fixed inset-0 z-[200] flex items-center justify-center p-6 sm:p-12 overflow-hidden">
      ...
      >
        ...
        <div className="flex-1 p-8 sm:p-14 flex flex-col justify-center relative bg-[var(--bg-secondary)]">
          <button 
            onClick={() => onComplete()}
            className="absolute top-10 right-10 text-[15px] font-semibold text-[var(--accent)] active:opacity-40 transition-opacity"
          >
            Skip
          </button>
              ...
              <div className="pt-8 flex flex-col gap-4">
                ...
                {currentStep > 0 && (
                  <button 
                    ...
                    className="ios-button-gray w-full py-4 text-[17px]"
                  >
                    Back
                  </button>
                )}
